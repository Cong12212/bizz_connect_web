...
export default function ContactList({
    items, total, page, last, onPage, selectedId, onSelect, onDelete, loading,
}: {
    items: Contact[];
    total: number;
    page: number;
                        ...
                        : items.length ? items.map((c) => (
                            <li key={c.id} className="group relative">
                                ...
                                <div
                                    ...
                                    className={`cursor-pointer rounded-xl px-3 py-2 text-left hover:bg-slate-100 ${selectedId === c.id ? "bg-slate-100 ring-1 ring-slate-200" : ""
                                        }`}
                                >
                                    <div className="flex items-start gap-3">
                                        ...
                                        <button
                                            ...
                                            className="inline-flex rounded-md bg-white/80 px-2 py-1 text-xs text-rose-600 ring-1 ring-rose-200 hover:bg-rose-50
